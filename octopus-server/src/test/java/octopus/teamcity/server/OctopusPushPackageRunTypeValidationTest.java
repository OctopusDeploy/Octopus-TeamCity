...
class OctopusPushPackageRunTypeValidationTest {
  ...
  private Collection<String> validate(final Map<String, String> properties) {
    final OctopusPushPackageRunType runType =
        new OctopusPushPackageRunType(mock(RunTypeRegistry.class), mock(PluginDescriptor.class));
  ...
  private Map<String, String> withMandatoryNonCredentialFields(
    ...
    properties.put(CONSTANTS.getPackagePathsKey(), "bin/**/*.nupkg");
    return properties;
  }

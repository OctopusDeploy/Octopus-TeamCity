...
public class OctopusRunRunbookRunType extends RunType {
  private final PluginDescriptor pluginDescriptor;

  public OctopusRunRunbookRunType(
  ...
  public String getType() {
    return OctopusConstants.RUN_RUNBOOK_RUNNER_TYPE;
  }

  @NotNull
  @Override
  public String getDisplayName() {
    return "OctopusDeploy: Run runbook";
  }

  @NotNull
  @Override
  public String getDescription() {
    return "Runs a runbook in Octopus Deploy";
  }
  ...
  public PropertiesProcessor getRunnerPropertiesProcessor() {
    ...
    return new PropertiesProcessor() {
      ...
      public Collection<InvalidProperty> process(@Nullable final Map<String, String> p) {
        ...
        checkNotEmpty(p, c.getRunbookNameKey(), "Runbook must be specified", result);
        checkNotEmpty(p, c.getDeployToKey(), "Environment(s) must be specified", result);
  ...
  public String getEditRunnerParamsJspFilePath() {
    return pluginDescriptor.getPluginResourcesPath("forms/editOctopusRunRunbookForm.jsp");
  }

  @Nullable
  @Override
  public String getViewRunnerParamsJspFilePath() {
    return pluginDescriptor.getPluginResourcesPath("viewOctopusRunRunbook.jsp");
  }

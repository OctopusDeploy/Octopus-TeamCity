    ...
    try (final OctopusTeamCityStack stack = SharedStack.full()) {
      ...
      PlaywrightUi.withLoggedInPage(
          ...
          page -> {
            ...
            // Wait for the Octopus form to render, then save it with an empty Server URL.
            // TeamCity's
            ...
            // The server-side processor renders its error into the matching span and the dialog
            // stays
